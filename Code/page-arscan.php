...
<html>
    <head>
        ...
        <script async src="//apps.8thwall.com/xrweb?appKey=uDTf8XBaSUdFebkZ5EVegGhaxTHxDX4KcEzM4Z1fIUddUfwuE7JRHuVFgK3kvaDUmz8cTO"></script>
        
        <script src="https://cdn.jsdelivr.net/npm/vue/dist/vue.js"></script>
        <script src="js/arscan.js"></script>
        <link rel="stylesheet" href="style/page-arscan.min.css">
    </head>
